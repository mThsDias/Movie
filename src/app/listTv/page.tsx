...
import * as S from "../listMovie/styles";
...
export default function ListTv() {
  const [movieList, setMovieList] = React.useState<Tv[]>([]);
  ...
  const api = `https://api.themoviedb.org/3/tv/popular?api_key=${apiKey}&language=en-US&page=`;
  useEffect(() => {
    setLoading(true);
